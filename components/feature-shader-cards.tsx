            ...
            return (
              <div key={index} className="relative h-80 md:h-96 group cursor-pointer">
                <div className="absolute inset-0 rounded-3xl overflow-hidden transition-transform duration-300 group-hover:scale-105">
                 ...
                 <div className="relative z-10 p-6 sm:p-8 rounded-3xl h-full flex flex-col bg-black/80 border border-white/10 transition-all duration-300 group-hover:-translate-y-2 group-hover:shadow-2xl group-hover:bg-black/90 group-hover:border-white/20">
