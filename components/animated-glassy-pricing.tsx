...
export const PricingCard = ({
  ...
  const cardClasses = `
    backdrop-blur-[14px] bg-gradient-to-br rounded-2xl shadow-xl flex-1 w-full px-7 py-8 flex flex-col transition-all duration-300 cursor-pointer
    from-black/5 to-black/0 border border-black/10 hover:-translate-y-2 hover:shadow-2xl
    dark:from-white/10 dark:to-white/5 dark:border-white/10 dark:backdrop-brightness-[0.91] dark:hover:shadow-cyan-400/20
    ${isPopular ? 'scale-105 relative ring-2 ring-cyan-400/20 dark:from-white/20 dark:to-white/10 dark:border-cyan-400/30 shadow-2xl hover:scale-110' : 'hover:scale-105'}
  `;
  const buttonClasses = `
...
export const ModernPricingPage = ({
  ...
  return (
    <div className="bg-background text-foreground min-h-screen w-full overflow-x-hidden">
      ...
      <main className="relative w-full min-h-screen flex flex-col items-center justify-center px-6 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-8 lg:gap-10 w-full max-w-7xl mx-auto">
